...
*/
const stuGithub = axios.get('https://api.github.com/users/stu-wd')
  .then(res => res.data) 
...
//text content
  ...
  githubName.textContent = obj.name;
...
axios.get("https://api.github.com/users/stu-wd")
  .then(res => {
    let myCard = markupMaker(res.data);
    cards.appendChild(myCard)
  })
  .catch(err => console.log("can't do that dude"))
  .finally(() => console.log(`yah bud`));
